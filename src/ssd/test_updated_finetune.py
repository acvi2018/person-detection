...
testset = OkutamaDataset('/home/emds/data/okutama-action-drone-data/test_metadata.csv', 
     '/home/emds/data/okutama-action-drone-data/frames', 
     '/home/emds/data/okutama-action-drone-data/annotations',
      AnnotationTransform(voc_class_map), SSDAugmentation(ssd_dim, means))
...
with open('{0}_pred_details.pkl'.format(result_folder), 'wb') as fp:
...
fp1 = open('{0}_eval.txt'.format(result_folder), 'w')
