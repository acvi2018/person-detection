...
VOCroot = '/home/vijin/iith/project/data/VOCdevkit/' # path to VOCdevkit root dir
...
v2 = {
    ...
    # 'aspect_ratios' : [[2, 1/2, 3, 1/3, 1/4, 1/5], [2, 1/2, 3, 1/3], [2, 1/2, 3, 1/3],
    #                     [2, 1/2, 3, 1/3], [2, 1/2], [2, 1/2]],
    #'aspect_ratios' : [[2], [2, 3], [2, 3], [2, 3], [2], [2]],
    'aspect_ratios' : [[2, 3, 4, 5], [2, 3], [2, 3], [2, 3], [2], [2]],
